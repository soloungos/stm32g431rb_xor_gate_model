...
#define AI_NETWORK_MODEL_SIGNATURE     "4190149b0cbbf616ac2ac5b4c011d7ae"
...
#define AI_TOOLS_DATE_TIME   "Sat Jan  6 13:57:57 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 2, 2, 1, 1), AI_STRIDE_INIT(4, 4, 8, 16, 16),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    36, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 16, 1, 1),
    16, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_2_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 8);
    dense_2_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8);
    ...
    dense_3_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 8);
    dense_3_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 0);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 16);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 24);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 24);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 32);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 32);
